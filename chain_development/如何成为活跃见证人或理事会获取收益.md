...
# 成为活跃理事会
## 1.手动代币映射
首先参照[COCOS-BCX节点环境搭建](./COCOS-BCX节点环境搭建.md) 下载并操作钱包，然后进行主网账户注册，由于目前理事会门槛需要5千万cocos，同时注册候选人操作耗费1000COCOS，所以需向项目方指定的erc地址打入最低价值5千万零1千cocos的钱，然后由项目方向提供的cocos主网账户地址打入相应的cocos。
