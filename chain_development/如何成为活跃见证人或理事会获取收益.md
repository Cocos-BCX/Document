...
# 成为活跃理事会
## 1.手动代币映射
首先参照[https://shimo.im/docs/TtqpPdcv6tKDPQTd](https://shimo.im/docs/TtqpPdcv6tKDPQTd) 下载并操作钱包，然后进行主网账户注册，由于目前理事会门槛需要5千万cocos，同时注册候选人操作耗费1000COCOS，所以需向项目方指定的erc地址打入最低价值5千万零1千cocos的钱，然后由项目方向提供的cocos主网账户地址打入相应的cocos。
...
# 成为活跃见证人
## **1.手动代币映射**
首先参照[https://shimo.im/docs/TtqpPdcv6tKDPQT](https://shimo.im/docs/TtqpPdcv6tKDPQTd) 下载并操作钱包，然后进行主网账户注册，由于目前理事会门槛需要5千万cocos，同时注册候选人操作耗费1000COCOS，所以需向项目方指定的erc地址打入最低价值5千万零1千cocos的钱，然后由项目方向提供的cocos主网账户地址打入相应的cocos。
...
## 3.搭建出块节点
参考链接[https://shimo.im/docs/RjrT3kwPkHqykGTt ](https://shimo.im/docs/RjrT3kwPkHqykGTt)搭建节点，安装docker运行安装脚本。
