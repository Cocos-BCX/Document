...
# 成为活跃理事会
## 1.拥有一定数量的主网COCOS
首先参照[Cocos-BCX二进制钱包说明和账户注册](./Cocos-BCX二进制钱包说明和账户注册.md) 下载并操作钱包，然后进行主网账户注册，由于目前理事会门槛需要5千万COCOS，同时注册候选人操作耗费1000COCOS，所以参照[COCOS 主网映射操作教程](https://mp.weixin.qq.com/s/Hw0nuCv4qrRU7VCjDn80Vw) 获取最低价值5千万零1千个主网COCOS。
